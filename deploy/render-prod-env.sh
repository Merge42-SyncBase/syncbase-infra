...

{
  ...
  printf '\n'
  write_literal SYNCBASE_DB_HOST "$SYNCBASE_PROD_DB_HOST"
  write_literal SYNCBASE_DB_PORT "${SYNCBASE_PROD_DB_PORT:-5432}"
  write_literal SYNCBASE_DB_NAME "${SYNCBASE_PROD_DB_NAME:-syncbase}"
  write_literal SYNCBASE_DB_SSLMODE "${SYNCBASE_PROD_DB_SSLMODE:-require}"
  printf '\n'
